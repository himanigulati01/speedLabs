        ...
        <div>
             <nav class="breadcrumb-nav">
                ...
                <div class="container holder">
                  <div class="align">
                  <h1><i className="fa fa-fw fa-shopping-cart"></i> Order History</h1>
                  </div>
                </div>
              </div>
            </nav> 
                    ...
                    <tbody>
                        {data.map((row)=>(
                            <tr>
                                ...
                                {row[1].order_status === "processed" ? <td data-title="status"><i className="success-status">Processed</i></td>:
                                <td><i className="pending-status">Pending</i></td>
                                }
                                
                                <td data-title="Amount">₹{(row[1].amount).toFixed(2)}</td>
                                <td data-title="Actions"><a href={`/orders/${row[0]}/details`}><i className="fa fa-fw fa-eye"></i></a></td>
                            </tr>
