    ...
    return (
        <>
				...
				<div class="slider fade-slider">
					<div>
						{/* intro block slide */}
						<article class="intro-block-slide overlay bg-cover" background-image="url(http://placehold.it/1920x823)">
			...
			{/* counter aside */}
			<aside class="bg-cover counter-aside background_1920_280">
			...
			{/* testimonials block */}
			<section class="testimonials-block text-center bg-gray bg_pattern_01">
				<div class="container">
					<div class="row">
