              ...
              <form action="#" class="cart-form">
                <div class="table-wrap">
                  ...
                  <table class="table tab-full-responsive cart-data-table font-lato">
                    ...
                    <tbody>
                      <tr>
                        <td><a href="#" class="btn-remove fas fa-times"><span class="sr-only">remove</span></a></td>
                        ...
                        <td data-title="Price"><span><strong class="price element-block"> $65558.00</strong></span></td>
                        <td data-title="Apply coupon">
                          <div>
                            <div className="quantity">
                            <input type="text" class="form-control" placeholder="Coupon Code"/>
                            <button className="apply-coupon">Apply</button><button className="remove-coupon">Remove</button>
                            </div>
                          </div>
                        </td>
                        <td data-title="Discount"><span><strong class="price element-block"> $68.00</strong></span></td>
                      ...
                      <tr>
                        <td colspan="2" class="text-right btn-actions">
                          <div>
                            <a href="#" class="btn btn-default font-lato fw-normal text-uppercase">Back to courses</a>
                          </div>
                        </td>
                      </tr>
                    </tbody>
                      ...
                      <table class="table table-cart-total">
                        <tbody>
                          <tr>
                            ...
                            <td><div class="price">£95.00</div></td>
                          </tr>
                          <tr>
                            <td class="font-lato fw-bold">Discount</td>
                            <td><div lass="price">£95.00</div></td>
                          </tr>
